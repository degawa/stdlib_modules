...
!! Hash function
    ...
    interface free_map_entry_pool
        !! Version: Experimental
        !!
        module procedure free_map_entry_pool_open
        !! Interface to internal procedure that finalizes an open hash map
        !! entry pool.
        module procedure free_map_entry_pool_chaining
...
!!     map - an open hash map
    ...
    subroutine free_chaining_map( map )
        !! Version: Experimental
        !!
    ...
    recursive subroutine free_map_entry_pool_chaining(pool) ! gent_pool_free
        !! Version: Experimental
        !!
        ...
        call free_map_entry_pool_chaining(pool % lastpool)
        deallocate( pool )

    end subroutine free_map_entry_pool_chaining

    recursive subroutine free_map_entry_pool_open(pool) ! gent_pool_free
        !! Version: Experimental
...
!         Trace component pointers/lists
            call free_map_entry_pool_open( lastpool )
        end if

    end subroutine free_map_entry_pool_open
